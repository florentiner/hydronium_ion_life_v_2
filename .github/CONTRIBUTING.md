# Contributing to hydronium_ion_life_v_2

We welcome you to [check the existing issues](https://github.com/florentiner/hydronium_ion_life_v_2/issues) for bugs or enhancements to work on.
If you have an idea for an extension to hydronium_ion_life_v_2, please [file a new issue](https://github.com/florentiner/hydronium_ion_life_v_2/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/florentiner/hydronium_ion_life_v_2/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/hydronium_ion_life_v_2.git
   ```
...
Finally, go to the web page of your fork of the hydronium_ion_life_v_2 repo, and click
...
If your contribution changes hydronium_ion_life_v_2 in any way:

- Update the [documentation](https://github.com/florentiner/hydronium_ion_life_v_2/tree/master/analyzer/zlib/doc) so all of your changes are reflected there.

- Update the [README](https://github.com/florentiner/hydronium_ion_life_v_2/tree/master/README.md) if anything there has changed.

If your contribution involves any code changes:

- Update the [project tests](https://github.com/florentiner/hydronium_ion_life_v_2/tree/master/analyzer/zlib/contrib/ada/test.adb) to test your code changes.
